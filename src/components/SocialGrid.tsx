...
const socialLinks: SocialLink[] = [
  ...
  { name: 'X', icon: 'https://cdn.simpleicons.org/x/ffffff', url: 'https://x.com/Pruuingoo', color: '#000000' },
  ...
  { name: 'Email', icon: 'https://cdn.simpleicons.org/gmail/ffffff', url: 'mailto:pruuingoo@gmail.com', color: '#EA4335' },
];
