...
const AboutSection = ({ onDiscordClick }: AboutSectionProps) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto mb-12 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
      ...
      {theme === 'landscape' && (
        <div className="flex justify-center mt-6 opacity-0 animate-bounce-in" style={{ animationDelay: '0.6s' }}>
          <Button
